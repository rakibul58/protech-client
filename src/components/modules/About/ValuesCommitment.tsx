import { Values } from "@/src/constant";
      ...
      <div className="mx-auto px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {Values.map((value, index) => (
            <div
              key={index}
              className="flex flex-col items-center p-6 bg-gray-600 bg-opacity-40 dark:bg-opacity-20 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out w-full"
            >
              <img
                src={value.icon}
                alt={value.title}
